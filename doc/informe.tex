...
Para este filtro desenrollaremos 10 ciclos procesando 40 pixeles por cada uno para luego comprar los resultados con su versi\'on normal. Nuestra hipótesis era que desenrollar ciclos mejora el rendimiento disminuyendo los ticks de clock usados ya que hay menos overhead de ciclos (comparaciones, saltos) y menos predicci\'on de saltos por parte del procesador.

\subsubsection{Accesos a memoria}

Utilizamos este experimento

\subsection{Dise\~no de instancias y aspectos t\'ecnicos}


\paragraph{} Para los experimentos de comparaci\'on de rendimiento armamos instancias de imagenes cuyas resoluciones son multiplo de $32*i \times 18*i$, $\forall i \in [1..100]$.
...
\subsubsection{Comparaciones}
	...
	\begin{figure}[h!]			
			...
			%\caption{asdasd}
		%\caption{Gr\'aficos comparativos de rendimiento entre cada filtro implementado con SIMD y diferentes optimizaciones de su implementaci\'on en C}
	\end{figure}
